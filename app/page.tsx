  ...
  return (
    loading ?
        ...
        <main className="h-full flex justify-center items-center">
          <div className="flex flex-wrap flex-col items-center absolute w-full max-w-[1600px] overflow-x-hidden duration-1000 bg-[rgba(0,0,0,0.2)] py-10 mb-12 z-1 animate-fadeIn lg:bg-transparent lg:items-start lg:duration-0 lg:px-12">
