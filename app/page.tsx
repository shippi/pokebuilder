...
export default function Home() {
  ...
  return (
    loading ?
        ...
        <div className="flex flex-wrap flex-col items-center absolute w-full max-w-[1500px] overflow-x-hidden bg-[rgba(0,0,0,0.2)] py-10 z-1 lg:bg-transparent lg:items-start lg:w-[90vw] ">
          <h1 className="font-roboto font-black text-center text-white text-[18vw] leading-none -skew-x-12 z-0 lg:text-[180px]" style={{wordSpacing: "-60px"}}>
            POKÉ BUILDER
          </h1>
          <div className="h-6 lg:h-12"/>
          <div className="flex flex-wrap items-center justify-center gap-2 lg:justify-between w-full">
            <h2 className="text-[20px] font-medium text-white md:text-xl lg:text-2xl lg:text-stone-700">Create and plan your Pokémon teams!</h2>
          ...
          <div className="flex flex-col gap-4 text-white lg:text-stone-700">
